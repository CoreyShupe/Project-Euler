...
import com.github.coreyshupe.projecteuler.p1to25.Problem12;
import com.github.coreyshupe.projecteuler.p1to25.Problem13;
import com.github.coreyshupe.projecteuler.p1to25.Problem14;
...
public final class Main {
  ...
  private static Map<Integer, Problem<?>> registerProblems() {
    ...
    try {
      ...
      registerProblem(Problem12.class, map);
      registerProblem(Problem13.class, map);
      registerProblem(Problem14.class, map);
